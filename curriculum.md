...
process note: 100 at 216, 101 at 182, 102 at 206, 103 at 193, 104 at 233, 105 at 220, 106 at 198, 107 at 205, 108 at 314 under the 350 capstone ceiling. the brick cluster stayed loose and steady and only the capstone ran long, which is what the wider budget is for.

last visuals: mermaid flowchart, ten nodes, two diamonds and a branch that rejoins, every label carrying its note number (108), table, three rows and three columns, public rank against my own score with the order inverting (107), mermaid flowchart, eight nodes, three diamonds chained down with a cost label on every lever (106). two mermaid in the last three, so a third one in a row is out if the repo continues.
last exits: stops (108), stops (107), forward (106). two stops running, so a note after this one may point forward.
